...
enum class GetActiveBolusDeliveryResponseFlags constructor(val bit:Int) {
    ...
    companion object {
         ...
         */
        fun parseFlags(characteristicFlags: Int): EnumSet<GetActiveBolusDeliveryResponseFlags> {
            val setFlags = EnumSet.noneOf(GetActiveBolusDeliveryResponseFlags::class.java)
            GetActiveBolusDeliveryResponseFlags.values().forEach {
                val flag = it.bit
