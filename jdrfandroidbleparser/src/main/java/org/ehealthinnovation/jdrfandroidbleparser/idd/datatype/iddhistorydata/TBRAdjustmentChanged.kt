...
class TBRAdjustmentChanged : BaseOperandParser {

    override val tag = TBRAdjustmentChanged::class.java.canonicalName as String
    ...
    var elapsedTBRDurationSinceLastChangeOrStart: Int? = null
    ...
    override fun parse(): Boolean {
        ...
        elapsedTBRDurationSinceLastChangeOrStart = getNextInt(BluetoothGattCharacteristic.FORMAT_UINT16)
        flags?.let {
